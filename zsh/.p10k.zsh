# Generated by Powerlevel10k configuration wizard on 2021-10-20 at 12:14 EEST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 19497.
# Wizard options: compatible, rainbow, unicode, flat heads, blurred tails, 2 lines,
# dotted, no frame, dark-ornaments, compact, concise, instant_prompt=verbose.
